      ...
      <div className="flex items-center justify-start w-full flex-col relative max-h-[75vh]">
        <div className="overflow-y-auto flex items-center justify-start w-full flex-col relative max-h-[75vh]">
          <label
            ...
            className={cn(
              "flex flex-col items-center justify-start w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
            )}
          >
